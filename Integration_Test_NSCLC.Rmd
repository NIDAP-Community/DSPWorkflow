...
```{r Study Design, echo=FALSE}
  ...
  #PKCFiles <- unzip("/rstudio-files/ccr-dceg-data/data/NSCLC_Dataset/pkcs/Hsa_WTA_v1.0.pkc.zip")
  ...
  #studyDesignHumanNSCLC <- sdesign.list$dsp.obj
  
  #saveRDS(studyDesignHumanNSCLC, file = "studyDesignHumanNSCLC.RDS")
