...
qc.output <-  qcProc(object = sdesign.list$object,
    ...
    if(create.rds) {
      ...
      saveRDS(qc.human.kidney, file = "tests/testthat/fixtures/Human_Kidney/qcHumanNSCLC.RDS")
  }
...
```{r Filtering, echo=FALSE}
  ...
  if(create.rds) {
    ...
    saveRDS(filtering.human.kidney, file = "tests/testthat/fixtures/Human_Kidney/filteringHumanNSCLC.RDS")
  } 
