...
```{r Study Design, echo=FALSE}
  ...
  if(create.rds) {
    ...
    saveRDS(study.design.human.kidney, file = "tests/testthat/fixtures/Human_Colon_CPTR/studyDesignHumanColonCPTR.RDS")
  }
...
```{r Spatial Deconvolution, echo=FALSE}
    ...
    spatial.output <- spatialDeconvolution(object = normalization.output$object, 
                                           expr.type = "q_norm", 
                                           ref.mtx = ref.mtx, 
                                           ref.annot = ref.annot, 
                                           cell.id.col = "CellID", 
